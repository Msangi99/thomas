<div class="px-4 py-6 h-screen overflow-y-auto">
    ...
    <nav class="space-y-1">
        ...
        <a href="{{ route('special_hire.drivers.create') }}" 
           class="sidebar-link flex items-center px-3 py-2.5 text-white rounded-lg {{ request()->routeIs('special_hire.drivers.create') || request()->routeIs('special_hire.drivers.reset_password') ? 'active' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
