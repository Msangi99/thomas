...
@section('content')
    <div class="payment-result-container">
        ...
        <div class="result-card failed">
            <div class="card-glow failed"></div>
            ...
            <div class="result-header">
                ...
                <h1 class="result-title">{{ __('all.payment_failed') ?? 'Payment Failed' }}</h1>
                <p class="result-subtitle">{{ $message ?? 'Your payment could not be completed.' }}</p>
            </div>
            ...
            <div class="transaction-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="status-badge failed">
                        ...
                        <span class="status-text-badge">{{ strtoupper($status ?? 'FAILED') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <p>{{ __('all.payment_failed_message') ?? 'No money has been deducted from your account. Please try again or use a different payment method.' }}</p>
            </div>
    ...
    <style>
        ...
        * {
        ...
        .card-glow.failed {
            background: linear-gradient(90deg, transparent, var(--error), var(--error-light), var(--error), transparent);
        }
        ...
        .status-badge.failed .status-text-badge {
