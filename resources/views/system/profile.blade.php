            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 bg-blue-600 text-white">
                    <h3 class="text-xl font-semibold flex items-center">
                        ...
                        {{ __('system.profile.title') }}
                    </h3>
                </div>

                <!-- Card Body -->
                <div class="p-6">
                    <form action="{{ route('system.profile.update') }}" method="POST" class="space-y-4">
                        @csrf
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                                ...
                                {{ __('system.profile.password_hint') }}
                            </label>
                        ...
                        <div class="pt-4">
                            <button type="submit" 
                                ...
                                {{ __('system.profile.update_button') }}
                        </div>
                    </form>
                </div>
            </div>
