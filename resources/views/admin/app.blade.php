 ...
 <body class="bg-gray-100 font-sans">
     ...
     <div class="flex min-h-screen">
         <!-- Sidebar -->
         <nav id="sidebar"
             class="sidebar fixed top-0 bottom-0 left-0 w-64 bg-teal-800/80 backdrop-blur-lg text-white p-4 overflow-y-auto transition-all duration-300 md:w-64 -translate-x-full md:translate-x-0 z-[1000]">
