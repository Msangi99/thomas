...
@section('content')
    <div class="min-h-screen flex items-center">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Success Card -->
            <div
                class="rounded-xl bg-gray-50 shadow-xl overflow-hidden transition-all duration-300 transform hover:shadow-2xl">
                <!-- Header -->
                ...
                <div class="p-6 sm:p-8">
                        ...
                        <div class="relative">
                            <div class="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center">
                                <svg class="w-16 h-16 text-green-600 animate-check" viewBox="0 0 52 52">
                                    <circle class="stroke-green-600" cx="26" cy="26" r="25" fill="none" stroke-width="4"
                                        stroke-dasharray="166" stroke-dashoffset="166"></circle>
                                    <path class="stroke-green-600" fill="none" stroke-width="4" stroke-dasharray="48"
                                        stroke-dashoffset="48" d="M14.1 27.2l7.1 7.2 16.7-16.8"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-600">{{ $data->bus->busname->name }} |
                                        {{ $data->bus->bus_number }}</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-600">{{ $data->pickup_point ?? 'N/A' }} To
                                        {{ $data->dropping_point ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($data->bima == 1)
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium text-gray-600">{{ number_format($data->bima_amount, 2) }}</span>
                                    </div>
                                @endif
                                @if (!empty($data->discount))
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium text-gray-600">{{ number_format($data->discounta->discount_amount, 2) }}</span>
                                    </div>
                                @endif
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-800 text-sm font-medium rounded-full">Confirmed</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($data->tra_vnum)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 text-center">
                            <h5 class="text-sm uppercase tracking-wider text-gray-600 mb-3">TRA Receipt Verification</h5>
                            <div class="flex justify-center mb-4">
                                <div class="bg-white p-2 rounded shadow-sm">
                                    {!! DNS2D::getBarcodeHTML($data->tra_qr_url, 'QRCODE', 4, 4) !!}
                                </div>
                            </div>
                            <p class="text-sm text-gray-600">Verification: <span
                                    class="font-bold font-mono">{{ $data->tra_vnum }}</span></p>
                        </div>
                    @endif
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                        <a href="{{ url('/') }}"
                            class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-200 flex items-center justify-center">
                        ...
                        <form action="{{ route('ticket.print') }}" method="POST">
                            ...
                            <button type="submit"
                                class="px-6 py-3 border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-lg transition duration-200 flex items-center justify-center">
                                <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-center text-sm text-gray-500">
                        ...
                        <p>Nunua ticket mtandaoni kwa usalama wa hali ya juu wakati wowote na bila usumbufu kwa
                            kutembelea www.hisgc.co.tz au piga <a href="tel:*149*46*36#"
                                class="text-blue-600 hover:text-blue-800">*149*46*36#</a> halafu
                            fuata maelekezo ya kununua ticket au piga <a href="tel:+255755879793"
                                class="text-blue-600 hover:text-blue-800">+255 755 879
