        ...
        return fetch('https://nominatim.openstreetmap.org/search?format=json&q=' + encodeURIComponent(place) + '&limit=1', {
            ...
            .then(data => {
                if (data && data.length > 0) {
                    ...
                    alert('{{ __('vender/busroot.no_results_found') }}'.replace('[place]', place));
    ...
    document.getElementById('calculate').addEventListener('click', function () {
        ...
        function setStart() {
            ...
            if (startValue.match(coordRegex)) {
                ...
                } catch (e) { alert('{{ __('vender/busroot.invalid_start_coords') }}'); }
        ...
        function setEnd() {
            ...
            if (endValue.match(coordRegex)) {
                ...
                } catch (e) { alert('{{ __('vender/busroot.invalid_end_coords') }}'); }
                return Promise.resolve();
            }
